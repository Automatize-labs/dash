        ...
        if result['success']:
            if result.get('type') == 'message':
                ...
                return {
                    ...
                    "client_id": client_id,
                    "lead_phone": lead_phone,
                    "db_mode": "isolated" if config.get('supabase_url') else "admin" # Debug info
                }
